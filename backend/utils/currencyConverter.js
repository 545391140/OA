 ...
 */
const convertFromCNY = (amountCNY, targetCurrency, customRates = null) => {
 ...
 */
const convertToCNY = (amount, sourceCurrency, customRates = null) => {
 ...
 */
const getExchangeRate = (currency, customRates = null) => {
  const rates = customRates || DEFAULT_EXCHANGE_RATES;
